                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">
                                    <a href="{{ route('detail') }}">Product Details</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2" data-aos="zoom-in">
                            ...
                            <form action="{{ route('detail-add', $product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <button type="submit" class="btn btn-success px-4 text-white mb-3 btn-block">Add to
                                    cart</button>
                            </form>
                            @else
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img class="mr-3 rounded-circle" src="/images/icon-testimonial-1.png" alt="">
                                ...
                                <li class="media my-4">
                                    <img class="mr-3 rounded-circle" src="/images/icon-testimonial-2.png" alt="">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded-circle" src="/images/icon-testimonial-3.png" alt="">
                                    <div class="media-body">
