...
@section('content')
    <!-- Section Content -->
    <div@endsection class="section-content section-dashboard-home" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-12 mt-3">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-sell-product"
                                    role="tab" aria-controls="pills-home" aria-selected="true">Sell Product</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-buy-product"
